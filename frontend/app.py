...
#             if resp.ok:
#                 resp_data = resp.json()
#                 st.session_state["itinerary_origin"] = resp_data.get("origin", "")   # Chicago
#                 st.session_state["city"] = resp_data.get("city", "")                 # New York
#                 st.session_state["airport"] = resp_data.get("airport", "")
#                 st.session_state["arrival_time"] = resp_data.get("arrival_time", "")

#                 # Now, extract the main itinerary output
...
#     # Try to show route map
#     origin = st.session_state.get("itinerary_origin")
#     destination = st.session_state.get("city")
#     st.write("Map debug — origin:", origin, "destination:", destination)

#     if origin and destination:
#         with st.spinner("🗺️ Building route map..."):
